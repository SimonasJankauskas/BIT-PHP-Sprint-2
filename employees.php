...
<body>
    ...
    <div id="top_btns">
        ...
        <a href="createEmployee.php"><button id="top">Create new employee</button></a>
    ...
    <table id="main_tbl" style="width:40%" border="1px solid black";>
			...
			<tbody>
				...
				<tr>
                    ...
                    <td><a href="deleteEmployee.php?id=<?php echo $row['eid'];?>" onclick="return confirm('Are you sure?')"><button id="del_btn">Delete</button></a> <a href="edit.php?id=<?php echo $row['eid'];?>"><button id="edit_btn">Edit</button></a></td>
				</tr>
